              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">الاقسام الرئيسه</h3>
                   <h5><a href="/addcategory">اضافه قسم جديده</a></h5>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="/ourcategory/{{ $category->id }}">{{ $category->name }}</a></td>
                        <td><img src="upload/{{ $category->header_image }}" width="100px" height="100px"></td>
                          <td>
                         
                          <a class="btn btn-danger" href="/delete/{{ $category->id }}">delete</a>
                          <a class="btn btn-primary" href="{{url('/addcategory')}} ">Edit</a>
                          </td>
