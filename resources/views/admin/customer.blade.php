...
<section class="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li><a href="{{url('/addcustomer')}}"><i class="fa fa-link"></i> <span>اضافه عميل</span></a></li>
    <li class="treeview">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><img src="upload/{{ $customer->image }}" width="100px" height="100px"></td>
                          <td>
                         
                          <a class="btn btn-danger" href="/delete/{{ $customer->id }}">delete</a>
                          <a class="btn btn-primary" href="{{url('/addcustomer')}} ">Edit</a>
                          </td>
