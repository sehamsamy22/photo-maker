            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h5><a href="/addimage/{{ $category->id }}">اضافه صوره جديده</a></h5>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  @foreach ($category->images as $image)
                      <tr>
                      <td><img src="/upload/{{ $image->url }}" width="100px" height="100px"></td>
                          
                        <td>
                         
                          <a class="btn btn-danger" href="">delete</a>
                          <a class="btn btn-primary" href="/addimage/{{ $category->id }}">Edit</a>
                          </td>
